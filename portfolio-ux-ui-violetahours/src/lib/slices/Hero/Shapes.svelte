...
<!-- <Threlte.DirectionalLight position={[0, 10, 30]} intensity={3}></Threlte.DirectionalLight> -->
...
<!-- Diamond -->
<Geometry position={[1.7, 1.7, -4]} rate={0.7} geometry={new THREE.OctahedronGeometry(1.5)} />
